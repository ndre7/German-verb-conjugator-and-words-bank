      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-4 sm:p-6 shadow-xs space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-slate-900 font-vazir">
                {locale === "fa" ? "شبکه‌های واژگانی (مترادف، متضاد، هم‌خانواده، جهان معانی، اصطلاحات)" : "German Vocab Networks & Idioms"}
              </h2>
              <p className="text-xs text-slate-500 font-vazir">
                {locale === "fa"
                  ? "سازماندهی ارتباطات کلمات: مترادف‌ها، متضادها، کلمات هم‌خانواده، جهان معانی مشترک و اصطلاحات کاربردی با توجه به موقعیت"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-slate-100">
          <div className="flex items-center gap-1.5 font-vazir text-xs flex-wrap">
            ...
            >
              {locale === "fa" ? `جهان معانی (${semanticFieldCount})` : `Fields (${semanticFieldCount})`}
            </button>
            <button
      ...
      {loading ? (
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center space-y-3 font-vazir">
          ...
          <p className="text-xs text-slate-500 max-w-sm mx-auto">
            با استفاده از دکمه‌های بالا گروه جدید مترادف، متضاد، هم‌خانواده، جهان معانی یا اصطلاحات بسازید.
          </p>
        </div>
      ) : (
                ...
                <input
                  ...
                  placeholder={
                    formType === "word_family"
                      ...
                      : formType === "semantic_field"
                      ? "مثلاً: جهان معانی زمان (ساعت، روز، سال)"
                      : formType === "idiom"
